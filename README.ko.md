...
Peekaboo 문서는 아래 언어로 제공됩니다 — 인앱 현지화(i18n)가 기반으로 삼는 지원 언어셋입니다. 언어 코드는 BCP 47을 따릅니다.
...
인앱 UI 언어는 **설정**에서 바꿀 수 있습니다(자동 / English / 한국어 / 日本語 / 中文). *자동*은 시스템 로케일을 따릅니다. 중국어는 간체만 지원하며, 번체(`zh-Hant`)는 간체로 폴백됩니다.
