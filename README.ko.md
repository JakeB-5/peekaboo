...
> [!NOTE]
> **상태: 기획 / 설계 단계.** 현재 이 저장소에는 기획·설계 문서 세트만 있고 애플리케이션 코드는 아직 없습니다. 스택(Tauri v2, macOS)은 확정됐고 아키텍처도 명세돼 있습니다.
...
기획은 완료, 구현은 미착수. 진행 경로: **스캐폴딩 → MVP(오버레이 + 패닉) → 스텔스 본체(hover-reveal) → 은폐 → 폴리시·배포.** [로드맵](docs/roadmap.html) 참고.

---

<sub>개인용 도구를 위한 기획 연습입니다. 책임감 있게 사용하세요. 🫣</sub>
